...
# initial conditions
ic = flopy.mf6.ModflowGwfic(gwf, pname="ic", strt=50.0, filename=f"{gwfname}.ic")
...
ts_recarray = []
fd = open(os.path.join(sim_ws, "tides.txt"))
for line in fd:
